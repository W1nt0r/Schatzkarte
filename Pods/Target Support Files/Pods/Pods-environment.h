...
// AppQuestLogbuch
#define COCOAPODS_POD_AVAILABLE_AppQuestLogbuch
#define COCOAPODS_VERSION_MAJOR_AppQuestLogbuch 2
#define COCOAPODS_VERSION_MINOR_AppQuestLogbuch 0
#define COCOAPODS_VERSION_PATCH_AppQuestLogbuch 0
